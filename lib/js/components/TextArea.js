...
var TextArea = /** @class */ (function (_super) {
    ...
    function TextArea(props) {
            ...
            _this.currentLoadSuggestionsPromise = _this.currentLoadSuggestionsPromise
                ...
                if (_this.state.mention.status === "inactive") {
                    ...
                    if ('loading' in suggestions) {
                        _this.setState({
                            mention: __assign(__assign({}, _this.state.mention), { status: "active", suggestions: [], placeholder: suggestions.loading })
                        });
                    }
        ...
        if (props.setSuggestions) {
            props.setSuggestions.current = _this.setSuggestions;
        }
        return _this;
    }
    ...
    TextArea.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "mde-textarea-wrapper" },
            ...
            mention.status === "active" && (mention.suggestions.length || mention.placeholder) && (React.createElement(SuggestionsDropdown_1.SuggestionsDropdown, { classes: suggestionsDropdownClasses, caret: mention.caret, suggestions: mention.suggestions, placeholder: mention.placeholder, onSuggestionSelected: this.handleSuggestionSelected, suggestionsAutoplace: this.props.suggestionsAutoplace, focusIndex: mention.focusIndex, textAreaRef: this.props.refObject }))));
    };
    return TextArea;
}(React.Component));
